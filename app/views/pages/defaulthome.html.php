...
//var_dump(Session::read('web_user'));
$user = (Session::read('web_user'))?:null;
...
<?php if($user!=null):?>
<!--    <div class="test-result test-result-notice">-->
<!--        <fieldset>-->
            <h3>Welcome <?=$user['name'];?></h3>
<!--            Email : --><?//=$user['email'];?><!--<br>-->
<!--        </fieldset>-->
<!--    </div>-->
        <div class="test-result test-result-fail" style="text-align:right;">
            <a href="<?=$this->url('/users/dashboard/'.$user['_id']);?>" style="color:white;">Dashboard</a>&nbsp;&nbsp;&bull;&nbsp;
            <a href="<?=$this->url('/users/logout');?>" style="color:white;">Logout</a>
        </div>
<?php else:?>
