 ...
 */
defined('APP_PATH') or define('APP_PATH', "/skripsi-dev");

/**
 * Application base URL & upload url
 * for uploading, i need absolute path of server
 */
defined('SRV_APP_PATH') or define('SRV_APP_PATH', "/opt/lampp/htdocs".APP_PATH);
//upload url, with trailing / in ending
defined('DAI_UPLOAD_PATH') or define('DAI_UPLOAD_PATH', SRV_APP_PATH.'/app/webroot/public/');
...
/**
 * This file contains some configurations for authentication
 */
// require __DIR__. '/bootstrap/auth.php';

/**
 * Li3_swiftmailer configuration
 */
//require __DIR__ . '/bootstrap/swiftmailer.php';
